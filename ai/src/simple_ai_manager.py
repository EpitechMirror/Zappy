        ...
        for process_id, process in self.active_processes.items():
            if process.poll() is not None:  # Process has finished
                ...
                if process.returncode == 0:
                    ...
                    print(f"❌ AI Process #{process_id} exited with code {process.returncode}")
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Simple Zappy AI Manager - Spawn multiple AI clients using subprocess")
