#!/usr/bin/python3
##
## simple_ai_manager.py for Zappy in /home/adrien/Epitech/B-YEP-410/Zappy/ai/src
##
...
class SimpleZappyAIManager:
    """Simple AI Manager using subprocess instead of multiprocessing"""
    ...
    def spawn_ai_process(self) -> bool:
        """Spawn a new AI client using subprocess"""
        try:
            ...
            if (
                ...
                and len(self.active_processes) >= self.available_slots
            ):
            ...
            print(
                f"📊 Active processes: {len(self.active_processes)}/{self.max_processes}"
            )
        ...
        for process_id, process in self.active_processes.items():
            if process.poll() is not None:  # Process has finished
                ...
                if process.returncode == 0:
                    ...
                    print(
                        f"❌ AI Process #{process_id} exited with code {process.returncode}"
                    )
    ...
    def monitor_and_fork(self):
        ...
        print(f"🎮 Starting Simple Zappy AI Manager for team '{self.team_name}'")
...
def main():
    """Main function for Simple AI Manager"""
    parser = argparse.ArgumentParser(
        description="Simple Zappy AI Manager - Spawn multiple AI clients using subprocess"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        type=int,
        default=10,
        help="Maximum number of AI processes",
    )
    parser.add_argument(
        "--spawn-interval",
        type=float,
        default=2.0,
        help="Minimum time between spawns (seconds)",
    )

    args = parser.parse_args()

    print("🤖 Simple Zappy AI Manager - Subprocess-based AI Spawner")
    print("=" * 60)
