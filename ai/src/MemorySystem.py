...
class MemorySystem:
    ...
    def add_strategy(
        self, situation: str, action_sequence: List[int], success: bool, reward: float
    ):
        if success:
